 ...
 * Generated for Laravel 5.8.37 on 2020-04-20 06:16:51.
 *
...
namespace Pyaesone17\ActiveState { 
    ...
    class ActiveFacade {
         ...
         * @static 
         */ 
        public static function check($url, $deep = false, $active = null, $inactive = null)
        {
                        /** @var \Pyaesone17\ActiveState\Active $instance */
                        return $instance->check($url, $deep, $active, $inactive);
        }
         ...
         * @static 
         */ 
        public static function checkBoolean($url, $deep = false, $active = true, $inactive = false)
        {
                        /** @var \Pyaesone17\ActiveState\Active $instance */
                        return $instance->checkBoolean($url, $deep, $active, $inactive);
        }
         ...
         * @static 
         */ 
        public static function checkRoute($route, $active = null, $inactive = null)
        {
                        /** @var \Pyaesone17\ActiveState\Active $instance */
                        return $instance->checkRoute($route, $active, $inactive);
        }
         ...
         * @static 
         */ 
        public static function checkRouteBoolean($route)
        {
                        /** @var \Pyaesone17\ActiveState\Active $instance */
                        return $instance->checkRouteBoolean($route);
        }
         ...
         * @static 
         */ 
        public static function checkQuery($fullUrlWithQuery, $active = null, $inactive = null)
        {
                        /** @var \Pyaesone17\ActiveState\Active $instance */
                        return $instance->checkQuery($fullUrlWithQuery, $active, $inactive);
        }
         ...
         * @static 
         */ 
        public static function checkQueryBoolean($fullUrlWithQuery)
        {
                        /** @var \Pyaesone17\ActiveState\Active $instance */
                        return $instance->checkQueryBoolean($fullUrlWithQuery);
        }
...
namespace  { 
    ...
    class Active extends \Pyaesone17\ActiveState\ActiveFacade {}
