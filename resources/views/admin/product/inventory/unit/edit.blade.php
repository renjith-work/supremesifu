...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="global-settings-cover">
            <form action="{{ route('admin.product.inventory.unit.update', $unit->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane active" id="mainPane">
                                ...
                                <div class="gb-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" maxlength="255" value="{{ old('name', $unit->name) }}">
                                        @error('name') <p class="error-p">{{$errors->first('name')}}</p> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="abbrevation">Unit Abbrevation</label>
                                        <input type="text" name="abbrevation" class="form-control @error('abbrevation') is-invalid @enderror" id="abbrevation" maxlength="255" value="{{ old('abbrevation', $unit->abbrevation) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="type" class="form-control custom-select mt-15 @error('type') is-invalid @enderror" name="type">
                                            ...
                                            @foreach($types as $type)
                                                <option value="{{$type->id}}" @if($unit->type_id == $type->id) selected @endif>{{$type->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control wysiwyg @error('description') is-invalid @enderror" rows="5">{{ old('description', $unit->description) }}</textarea>
