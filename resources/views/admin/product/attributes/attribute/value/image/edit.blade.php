...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="global-settings-cover">
            <form action="{{ route('admin.product.attribute.value.image.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="mainPane">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Product Attribute Value Image Setting</h3>
                                </div>
                                <div class="gb-body">
                                    
                                    <div class="form-group">
                                        <label for="name">Image Property Name</label>
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" maxlength="255" value="{{ old('name', $setting->name) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" id="code" maxlength="255" value="{{ old('code', $setting->code) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="height" class="form-control @error('height') is-invalid @enderror" id="height" maxlength="255" value="{{ old('height', $setting->height) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="width" class="form-control @error('width') is-invalid @enderror" id="width" maxlength="255" value="{{ old('width', $setting->width) }}">
