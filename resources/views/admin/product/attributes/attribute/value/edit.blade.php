...
<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Product Attribute Value</li>
        </ol>
    </section>
    <section class="content">
        <div class="admin-footer-error">@include('admin.partials.flashErrorMessage')</div>
        <div class="global-settings-cover">
            <form action="{{ route('admin.product.attribute.value.update', $value->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="mainPane">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Product Attribute Value</h3>
                                </div>
                                <div class="gb-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="value" class="form-control @error('value') is-invalid @enderror" id="value" maxlength="255" value="{{ old('value', $value->value) }}">
                                        @error('value') <p class="error-p">{{$errors->first('value')}}</p> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Attribute Description</label>
                                        <textarea name="description" id="description" class="form-control wysiwyg @error('description') is-invalid @enderror" rows="5">{{ old('description', $value->description) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" id="price" maxlength="255" value="{{ old('price', $value->price) }}">
                            ...
                            <div class="tab-pane" id="imagePane">
                                ...
                                <div class="gb-body">
                                    <div class="form-group">
                                        ...
                                        <div id="d_image_preview" class="row">
                                            @if($value->d_image)<div class='col-md-4 upload-multi-img'><img src="/images/product/attributes/{{$value->d_image}}"></div>@endif
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div id="d_drawing_preview" class="row">
                                            @if($value->d_drawing)<div class='col-md-4 upload-multi-img'><img src="/images/product/attributes/{{$value->d_drawing}}"></div>@endif
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div id="c_image_preview" class="row">
                                            @if($value->c_image)<div class='col-md-4 upload-multi-img'><img src="/images/product/attributes/{{$value->c_image}}"></div>@endif
                                        </div>
                                    </div>
                                </div>
