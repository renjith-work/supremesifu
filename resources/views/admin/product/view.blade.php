            ...
            <div class="col-md-8">
                <div class="box cms-form-box-cover">
                    ...
                    <div class="show-box-body">
                        <div class="post-show-image row">
                            <div class="col-md-4"><img src="/images/product/product/{{$product->p_image}}" alt=""></div>
                        </div>
                    ...
                    <div class="show-box-body">
                        <div class="show-group">
                            ...
                            <div class="show-group-body">
                                <span class="label label-success show-tag-label">{{$product->productCategory->name}}</span>
                            </div>
                        </div>
                        <div class="show-group">
                            <div class="side-show-title">
                            ...
                            <div class="show-group-body">
                                <span class="label label-success show-tag-label">{{$product->fabric->name}}</span>
                            </div>
                        </div>
