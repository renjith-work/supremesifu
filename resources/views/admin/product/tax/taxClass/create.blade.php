...
<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/product/tax/class">Tax Class  Management</a></li>
            <li class="active">Create Tax Class </li>
        </ol>
    </section>
    <section class="content">
        <div class="admin-footer-error">@include('admin.partials.flashErrorMessage')</div>
        <div class="global-settings-cover">
            <form action="{{route('admin.product.tax.class.store')}}" method="POST" enctype="multipart/form-data" data-parsley-validate >
                {{ csrf_field() }}
                <div class="row user">
                    <div class="col-md-3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="mainPane">
                                <div class="box-header">
                                    <h3 class="box-title">Create Tax Class </h3>
                                </div>
                                <div class="gb-body">
                                    ...
                                    <div class="form-group">
                                        <label for="description">Tax Class Description</label>
