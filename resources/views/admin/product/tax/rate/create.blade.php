...
<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Create Tax Rate </li>
        </ol>
    </section>
    <section class="content">
        <div class="admin-footer-error">@include('admin.partials.flashErrorMessage')</div>
        <div class="global-settings-cover">
            <form action="{{route('admin.product.tax.rate.store')}}" method="POST" enctype="multipart/form-data" data-parsley-validate >
                {{ csrf_field() }}
                <div class="row user">
                    <div class="col-md-3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="mainPane">
                                <div class="box-header">
                                    <h3 class="box-title">Create Tax Rate </h3>
                                </div>
                                <div class="gb-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="rate" class="form-control @error('rate') is-invalid @enderror" id="rate" maxlength="255" value="{{ old('rate') }}">
