                            ...
                            <div class="tab-pane active" id="mainPane">
                                ...
                                <div class="gb-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" maxlength="255" value="{{ old('name', $category->name) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="parent" class="form-control custom-select mt-15 @error('parent') is-invalid @enderror" name="parent">
                                            ...
                                            @foreach($parents as $parent)
                                                @if($parent->id != 1 && $parent->id != $category->id) 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control wysiwyg @error('description') is-invalid @enderror" rows="5">{{ old('description', $category->description) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="menu" class="form-control custom-select mt-15 @error('menu') is-invalid @enderror" name="menu">
                                            <option value="1" @if($category->menu == 1) selected @endif>Yes</option>
                                            <option value="0" @if($category->menu == 0) selected @endif>No</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="is_filterable" class="form-control custom-select mt-15 @error('is_filterable') is-invalid @enderror" name="is_filterable">
                                            <option value="1" @if($category->is_filterable == 1) selected @endif>Yes</option>
                                            <option value="0" @if($category->is_filterable == 0) selected @endif>No</option>
                                        </select>
                                        @error('is_filterable') <p class="error-p">{{$errors->first('is_filterable')}}</p> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="metatag">Meta Tags</label>
                                        <textarea name="metatag" id="metatag" class="form-control @error('metatag') is-invalid @enderror" rows="5">{{ old('metatag', $category->metatag) }}</textarea>
                                        @error('metatag') <p class="error-p">{{$errors->first('metatag')}}</p> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="metadescp">Meta Description</label>
                                        <textarea name="metadescp" id="metadescp" class="form-control @error('metadescp') is-invalid @enderror" rows="5">{{ old('metadescp', $category->metadescp) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="image_preview" class="row">
                                            @if($category->image)<div class='col-md-4 upload-multi-img'><img src="/images/product/category/{{$category->image}}"></div>@endif
                                        </div>
                                    </div>
                                </div>
