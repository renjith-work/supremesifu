...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="global-settings-cover">
            <form action="{{route('admin.product.fabric.class.store')}}" method="POST" enctype="multipart/form-data" data-parsley-validate >
                {{ csrf_field() }}
                <div class="row user">
                    <div class="col-md-3">
                            ...
                            <div class="tab-pane active" id="mainPane">
                                ...
                                <div class="gb-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" class="form-control @error('price') is-invalid @enderror" id="price" maxlength="255" value="{{ old('price') }}">
