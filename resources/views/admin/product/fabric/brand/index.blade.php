            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="/admin/product/fabric/brand/create" class="btn btn-warning pull-right">Create Brand</a>
                    </div>
                                ...
                                <td style="width: 150px;">
                                    <div class="action-ul-cover">
                                        <ul>
                                            ...
                                            <li><a href="/admin/product/fabric/brand/{{$brand->id}}/edit" class="crud-ab-cover ab-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li>
                                            <li><a href="/admin/product/fabric/brand/{{$brand->id}}/delete" class="crud-ab-cover ab-delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
