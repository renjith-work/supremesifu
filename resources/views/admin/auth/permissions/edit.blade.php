            ...
            <div class="col-md-9 col-md-offset-2">
                <div class="box cms-form-box-cover">
                    <div class="box-header with-border form-box-head">
                        <h3 class="form-box-title">Edit Permissions</h3> 
                    </div>

                    <div class="form-box-body">
                        <form action="{{ route('admin.auth.permissions.update', $permission->id) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('PUT') }}
                        <div class="form-group">
                            <label for="name">Permissions Name</label>
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" maxlength="255" value="{{ old('name', $permission->name) }}">
