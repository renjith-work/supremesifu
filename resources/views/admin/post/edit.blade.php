                            ...
                            <div class="tab-pane active" id="mainPane">
                                ...
                                <div class="gb-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="name" maxlength="255" value="{{ old('title', $post->title) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="bodyE" id="bodyE" class="form-control wysiwyg @error('bodyE') is-invalid @enderror" rows="5">{{ old('bodyE', $post->bodyE) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="bodyH" id="bodyH" class="form-control @error('bodyH') is-invalid @enderror" rows="5">{{ old('bodyH', $post->bodyH) }}</textarea>
                            ...
                            <div class="tab-pane" id="imagePane">
                                ...
                                <div class="gb-body">
                                    <div class="form-group">
                                        ...
                                        <select id="design" class="form-control custom-select mt-15 @error('design') is-invalid @enderror" name="design">
                                            @foreach($designs as $design)
                                                @if($design->id == $post->design_id)
                                                    <option value="{{$design->id}}" selected> {{$design->name}} </option>
                                                @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="video" id="video" class="form-control @error('video') is-invalid @enderror" rows="1">{{ old('video', $post->video) }}</textarea>
                                        ...
                                        <div id="images_preview" class="row">
                                            @foreach($images as $image)
                                                <div class='col-md-4 upload-multi-img'>
                                                    ...
                                                    <a href="/admin/post/image/delete/{{$post->id}}/{{$image}}" class="btn btn-md btn-danger btn-listing ">Delete Image</a>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="seoPane">
                                ...
                                <div class="gb-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="metatag" id="metatag" class="form-control @error('metatag') is-invalid @enderror" rows="5">{{ old('metatag', $post->metatag) }}</textarea>
                                        @error('metatag') <p class="error-p">{{$errors->first('metatag')}}</p> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="metadescp">Meta Description</label>
                                        <textarea name="metadescp" id="metadescp" class="form-control @error('metadescp') is-invalid @enderror" rows="5">{{ old('metadescp', $post->metadescp) }}</textarea>
