...
<ul class="nav flex-column px-dashboard-list">
    ...
    <li><a href="/user/order-management" class="{{ Active::checkRoute(['user.order-management','user.order-management.details', 'user.order-management.product' ]) }}">Order Management</a></li>
