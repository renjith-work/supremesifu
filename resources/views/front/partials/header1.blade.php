...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="57x57" href="/front/assets/images/fav/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/front/assets/images/fav/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/front/assets/images/fav/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/front/assets/images/fav/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/front/assets/images/fav/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/front/assets/images/fav/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/front/assets/images/fav/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/front/assets/images/fav/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/front/assets/images/fav/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="/front/assets/images/fav/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/front/assets/images/fav/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/front/assets/images/fav/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/front/assets/images/fav/favicon-16x16.png">
...
<div class="main-wrapper">
    ...
    <div class="header-area">
            <!-- header-top start -->
            <div class="header-top line-border">
            <div class="container">
                <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 order-lg-1 col-md-5 order-1">
                            <div class="top-selector-wrapper">
                                <div class="single-top-selector-left">
                            ...
                            <div class="header-bottom-right">
                                ...
                                <div class="shoping-cart">
                                    <div class="btn-group">
                                        ...
                                        <button class="dropdown-toggle"><i class="fa fa-shopping-bag"></i> Cart (2)</button>
                                                ...
                                                <ul class="mini-cart-content">
                                                    ...
                                                    <li class="mini-cart-item">
                                                        <div class="mini-cart-product-img">
                                                            <a href="#"><img src="/front/assets/images/cart/1.jpg" alt=""></a>
                                                    ...
                                                    <li class="mini-cart-item">
                                                        <div class="mini-cart-product-img">
                                                            <a href="#"><img src="/front/assets/images/cart/3.jpg" alt=""></a>
                                                            <span class="product-quantity">1x</span>
                                                        </div>
                                                        <div class="mini-cart-product-desc">
            ...
            <div class="header-bottom-area header-sticky">
                <div class="container">
                    <div class="row top-header-border">
                        <div class="col-lg-12 d-none d-lg-block">
                            ...
                            <div class="main-menu-area text-center">
                                ...
                                <ul>
                                    ...
                                    <li><a href="/design/shirt">Design A Shirt</a></li>
                                    <li><a href="/collection/shirts">Browse Collection</a></li>
                                    {{-- <li><a href="">Jackets</a></li>
                                    <li><a href="">Trousers</a></li> --}}
                                    <li>
                                        <a href="/guides">Supreme Sifu Guides</a>
                                        <ul class="sub-menu">
