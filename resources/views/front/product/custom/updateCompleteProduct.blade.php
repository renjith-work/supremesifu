                    ...
                    <div class="px-auth-box-body">
                        <div class="product-message-cover">
                            ...
                            <div class="product-message-text-cover">
                                <p>
                                    You have successfully updated the product with the <span><a href="#">Supreme Sifu Smart Dresser Tool</a></span>.<br>
                                    We have updated the product in the cart. You may view and edit the product from the <a href="/cart">cart</a>. 
                                </p>
